          ...
          <a class="nav-link dropdown-toggle mx-2 text-white" href="#" id="submenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">
           Things to do Ireland
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-end" aria-labelledby="submenu">
              <li><a class="dropdown-item " href="../counties/c_clare/co_clare_index.php">Co. Clare</a></li>
              <li><a class="dropdown-item" href="../counties/c_donegal/co_donegal_index.php">Co. Donegal</a></li>
              <li><a class="dropdown-item" href="#">Something else here</a></li>
            </ul>
        </li>
         <li class="nav-item"><a href="#" class="nav-link  active px-3 ">Blog</a></li>
      </ul>
...
<?php
  ...
  $post_a = single_select_d('post','yes');
...
<main class="container mt-3 mb-5">
  ...
  <div class="row mb-2">
    ...
    <?php  
    while($all=$post_a->fetch_assoc()){
      $date = strtotime($all['created_at']);
      $cont = htmlspecialchars_decode($all['content_html']);
      echo '
       <div class="col-md-6">
        <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <h3 class="mb-0">'.$all['title'].'</h3>
            <div class="mb-1 text-muted">'.date('   F  d  Y',$date).'</div>
            <p class="card-text mb-auto">'.substr($cont,0,150).' ...</p>
            <a href="post_page.php?post_id='.$all['id'].'" class="stretched-link">Continue reading</a>
          </div>
          <div class="col-auto d-none d-lg-block">
            <img  class="img-fluid img-thumbnail" src="assets/'.$all['image_name'].'">
          </div>
        </div>
    </div>
